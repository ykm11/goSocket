...
var (
    base_point = encryption.EncodeUCoordinate(encryption.U, 255)
)
...
func TestEcc1(t *testing.T) {
    ...
    alice_pub := encryption.X25519(alice_sec_bytes, base_point)
    ...
    bob_pub := encryption.X25519(bob_sec_bytes, base_point)
